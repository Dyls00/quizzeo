  ...
  return (
    <div className="max-w-md mx-auto p-6 space-y-4">
      ...
      <div className="space-y-2 mt-4">
        <Button label="Participer au Daily" href={`/dashboard/${code}/${projectId}/${userId}/daily/productivite`} color="bg-blue-300" />
        <Button label="Quitter la partie" href="/" color="bg-blue-500" />
        <Button label="Gérer les sprints" href={`/dashboard//${code}/${projectId}/${userId}/sprints/delete`} color="bg-green-300" />
        <Button label="Gérer le Daily" href={`/dashboard/${code}/${projectId}/${userId}/daily/delete`} color="bg-green-400" />
        <Button label="Gérer les stories" href={`/dashboard//${code}/${projectId}/${userId}/stories/delete`} color="bg-purple-300" />
        <Button label="Gérer les participants" href={`/dashboard/${code}/${projectId}/${userId}/participants`} color="bg-yellow-300" />
      </div>
    </div>
  );
}
